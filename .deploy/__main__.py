import pulumi
from pulumi_azure import core, storage, servicebus, appservice
...
scheduler_account = storage.Account('schedulerstorage',
...
appservice.FunctionApp("serverless-scheduler",
                       resource_group_name=resource_group.name,
...
pulumi.export('connection_string', scheduler_account.primary_connection_string)
